        ...
        <section className="relative min-h-screen flex items-center bg-gradient-subtle overflow-hidden pt-8 sm:pt-0">
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        */}
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button onClick={goToSignup} className="w-full sm:w-48 h-14 rounded-lg bg-primary py-2 px-4 justify-center text-sm mt-14 text-white data-[hover]:bg-gray-800">
                                {'Get Started →'}
                            </button>
                        </div>
                    ...
                    <div
                        className={`relative lg:col-span-2 flex flex-col items-center justify-center ${isEnabled ? 'bg-gradient-radial from-primary/40 via-primary/0 to-primary/0' : ''}`}
                    >
