...
const Signup = () => {
    ...
    return (
        <div className='w-screen h-screen flex flex-col bg-[#fff7ed]'>

            <div className='relative w-full md:w-[350px] lg:w-[500px] m-auto py-16 px-[90px] space-y-3 border border-gray-950 rounded-lg'>
                ...
                <form onSubmit={authSignipFormik.handleSubmit} className='w-full flex flex-col'>
                    ...
                    {!password &&
                        <button type='button' onClick={continueSignUp} disabled={!authSignipFormik?.values.email} className="relative w-full sm:w-80 h-12 mx-auto rounded-lg bg-gray-950 py-2 px-4 text-sm mt-8 text-white data-[hover]:bg-gray-800 cursor-pointer">
                            {'Continue →'}
                        </button>
                    }

                    {password &&
                        <button type='submit' className="relative w-full sm:w-80 h-12 mx-auto rounded-lg bg-gray-950 py-2 px-4 text-sm mt-8 text-white data-[hover]:bg-gray-800">
